...
intro = ('Welcome to the FEBID simulator. \n'
            ...
            ' To start a session without a GUI use \n'
            ' \t `python -m febid no_gui <configuration_file>` \t this command will start the simulation right away. \n'
            ...
            ' \t `python -m febid show_animation <directory>` \t if a directory is not specified, a directory proompt window will open. \n')
